...
终于能上线hugo，太难了，一步一个报错，尤其是推送githu总是报错，搞了个deploy.sh自动化部署，hugo比hexo便捷，Github Pages需要也自己一步步挂载上去，也用不了npm来直接安装deploy-git，然后命令部署。



不过今天测试成功上线博客终于成功啦（雀跃），现在对于这个stack主题还是很满意的，比hexo的安知鱼主题简洁。
